  ...
  <div className="flex flex-col gap-4">
    <motion.div {...fade(0.25)} className="flex flex-col items-center">
      ...
      <div className="flex flex-wrap gap-2">
        {STACK.map(tech => (
          <span key={tech} className="border border-foreground/10 text-foreground/50 text-[11px] tracking-wide px-3 py-1.5 rounded-md">
            {tech}
          </span>
        ))}
      </div>
    ...
    <motion.div {...fade(0.25)} className="flex flex-col items-center">
      ...
      <div className="flex flex-wrap gap-2">
        {ECO_SYSTEMS.map(eco => (
          <span key={eco} className="border border-foreground/10 text-foreground/50 text-[11px] tracking-wide px-3 py-1.5 rounded-md">
            {eco}
          </span>
        ))}
      </div>
