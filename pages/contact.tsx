            ...
            <FieldSet>
              <FieldGroup>
                <FieldGroup className="flex flex-row">
                  <Field>
                    <FieldLabel htmlFor="name" className="text-foreground/40">Name <Required /></FieldLabel>
                    <Input required id="name" name="name" autoComplete="off" placeholder="Lenix Dev" defaultValue="An Anonymous" />
                  </Field>
                  <Field>
                    <FieldLabel htmlFor="email" className="text-foreground/40">Email <Required /></FieldLabel>
                    <Input required name="email" type='email' id="email" placeholder="contact@lenix.dev" />
                  </Field>
                </FieldGroup>
                <Field>
                  <FieldLabel htmlFor="subject" className="text-foreground/40">Subject <Required /></FieldLabel>
                  <Input required name="subject" type='text' id="email" placeholder="Interest" defaultValue="Unsubjected message" />
                </Field>
                <Field>
                  <FieldLabel htmlFor="message" className="text-foreground/40">Message <Required /></FieldLabel>
                  <InputGroup>
                    <InputGroupTextarea
                      value={value}
                      required
                ...
                <Field>
                  <FieldLabel htmlFor="files" className="text-foreground/40">Files</FieldLabel>
                  <Input id="files" name='files' type="file" multiple />
                  <FieldDescription>Select files to upload.</FieldDescription>
                </Field>
                <Field orientation="horizontal">
                  <Switch name="subscribe" id="newsletter" />
                  <FieldLabel htmlFor="subscribe" className="text-foreground/40">Subscribe to the newsletter</FieldLabel>
                </Field>
              </FieldGroup>
            </FieldSet>
          </form>
